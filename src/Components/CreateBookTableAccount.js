...
function CreateBookTableAccount() {
  return (
            ...
            <form>
                <div className='form-group'>
                    ...
                    <div className="mb-3 d-flex justify-content-end">
                        <input type="checkbox" className="form-check-input " />&ensp;<span style={{ color: 'blue', }}>By creating an account you agree to our Terms of Service and Privacy Policy</span>
                    </div>
                    <div className='mb-3 input-group input-group-lg'>
...
export default CreateBookTableAccount
